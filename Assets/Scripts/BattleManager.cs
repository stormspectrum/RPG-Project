...
public class BattleManager : MonoBehaviour
{
    ...
    public GameObject enemeyAttackEffect;
                ...
                if (GameManager.instance.playerStats[i].gameObject.activeInHierarchy)
                {
                    for (int j = 0; j < playerPrefabs.Length; j++)
                    {
                        if (playerPrefabs[j].charName == GameManager.instance.playerStats[i].charName)
                        {
                            ...
                            activeBattlers[i].armPwr = thePlayer.armrPwr;
                        }
                    }
                }
            }
    ...
    public void EnemyAttack()
    {
        ...
        Instantiate(enemeyAttackEffect, activeBattlers[currentTurn].transform.position, activeBattlers[currentTurn].transform.rotation);
    ...
    public void DealDamage(int target, int movePower)
    {
        ...
        float defPwr = activeBattlers[currentTurn].defense + activeBattlers[currentTurn].armPwr;
    ...
    {
        BattleManager.instance.itemMenu.SetActive(true);
    }
